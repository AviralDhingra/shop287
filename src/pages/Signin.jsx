  ...
  return (
    <React.Fragment>
      <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
        <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl mt-44">
          ...
          <form className="mt-6">
            <div className="mb-2">
              <label
                for="email"
                className="block text-sm font-semibold text-gray-800 uppercase"
              >
                Email
              </label>
              <input
          ...
          <div className="flex items-center place-content-evenly">
            <button
              ...
              class="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100 place-content-evenly hover:shadow-lg border-1 border-gray-100"
            >
              <div class="px-4 py-3">
              ...
              <h1 class="py-3 w-5/6 text-center text-gray-600 font-bold pl-0 pr-4">
                Sign in with Google
              </h1>
            </button>
          </div>
