const qualities = [
  ...
  //     description:
  //       "Using data and analytics to provide personalized product recommendations can help customers find items they are interested in and increase the chances of them making a purchase.",
  //   },
  //   {
  //     name: "Exclusive Collections",
  //     description:
  //       "Offering unique or exclusive products or collections that can't be found elsewhere can be a powerful way to differentiate an ecommerce store and create a sense of exclusivity or scarcity.",
  //   },
];
